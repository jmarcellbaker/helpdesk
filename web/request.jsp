...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="contact" style="margin-top:75px">
    ...
    <h1 class="w3-xxxlarge w3-text-red"><b>Assign Ticket</b></h1>
    <br>
    <p>Please Assign the ticket</p>
        ...
        <input type="text" name="technician" value="${serviceRequest.technician}" required><br>
        </div>
        <div class="w3-section">
        ...
        <label>&nbsp;</label>
        <input type="submit" value="Assign Ticket" class="w3-button w3-block w3-padding-large w3-red w3-margin-bottom">
    </form>
