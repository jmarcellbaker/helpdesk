<%-- 
    Document   : employee_reset
    Created on : Jul 5, 2017, 11:14:23 PM
    Author     : jmarc
--%>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="contact" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-red"><b>Password Reset</b></h1>
    <br>
    <p>Reset Your Password</p> 
    <h4 class="w3-text-red">${message}</h4>
    <form action="employeeReset" method="POST">
      ...
      <br>
      <input type="submit" value="Reset" class="w3-button w3-block w3-padding-large w3-red w3-margin-bottom">
    </form>  
  </div>
