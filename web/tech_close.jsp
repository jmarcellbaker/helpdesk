<%-- 
    Document   : tech_close
    Created on : Jul 7, 2017, 9:42:51 PM
    Author     : jmarc
--%>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="contact" style="margin-top:75px">
    ...
    <h1 class="w3-xxxlarge w3-text-red"><b>Close Request</b></h1>
    <br>
    <p>Add Notes and Close Ticket</p>
        ...
        <label>&nbsp;</label>
        <input type="submit" value="Close Request" class="w3-button w3-block w3-padding-large w3-red w3-margin-bottom">
    </form>
