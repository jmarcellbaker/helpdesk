<%-- 
    ...
    Created on : Jun 28, 2017, 8:34:38 PM
    Author     : jmarc
--%>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="contact" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-red"><b>Service Request</b></h1>
    <br>
    <p>Have an issue? Fill out the form below and a technician will be in touch shortly.</p> 
    <form action="createRequest" method="POST">
      <div class="w3-section">
        <label>Name</label>
        <input class="w3-input w3-border" type="text" name="requestedBy" value="${employee.firstName} ${employee.lastName}" readonly>
      </div>
      <div class="w3-section">
        <label>Email</label>
        <input class="w3-input w3-border" type="text" name="contactInfo" value="${employee.email}" readonly>
      </div>
      <div class="w3-section">
        <label>Service Description</label>
        <input class="w3-input w3-border" type="text" name="description" value="${description}" required>
      </div>
      <br>
      <input type="submit" value="Send Request" class="w3-button w3-block w3-padding-large w3-red w3-margin-bottom">
    </form>  
  </div>
