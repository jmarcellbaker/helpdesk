<%-- 
    Document   : employee_closed_request
    Created on : Jul 7, 2017, 8:14:08 PM
    Author     : jmarc
--%>
...
<p><a href="EmployeeRequestServlet?action=closed_requests&amp;employeeId=${employee.employeeId}">Refresh</a></p>
