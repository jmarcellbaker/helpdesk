<%-- 
    Document   : tech_closed_request
    Created on : Jul 7, 2017, 8:33:38 PM
    Author     : jmarc
--%>
...
<p><a href="TechRequestServlet?action=closed_requests&amp;techName=${tech.firstName} ${tech.lastName}">Refresh</a></p>
