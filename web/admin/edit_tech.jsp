<%-- 
    Document   : edit_tech
    Created on : Jul 7, 2017, 10:44:48 PM
    Author     : jmarc
--%>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="contact" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-red"><b>Edit Tech Account</b></h1>
    <br>
    <p>Enter New Details</p> 
    <form action="./newTech?action=update_tech" method="POST">
      <!--<div class="w3-section">
       ...
       <div class="w3-section">
        ...
        <input class="w3-input w3-border" type="text" name="firstName" value="${tech.firstName}" required>
      </div>
       <div class="w3-section">
        <label>Last Name</label>
        <input class="w3-input w3-border" type="text" name="lastName" value ="${tech.lastName}" required>
      </div>
      <div class="w3-section">
        <label>Email</label>
        <input class="w3-input w3-border" type="email" name="email" value="${tech.email}" required>
      </div>
      <br>
