<%-- 
    Document   : success_ticket
    Created on : Jul 5, 2017, 10:39:45 PM
    Author     : jmarc
--%>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="contact" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-red"><b>Request Details</b></h1>
    <br>
    <h2>A Technician Will Be Assigned to your Ticket Shortly!</h2>
    <br>
    <h3><b>Your Name:</b> ${serviceRequest.requestedBy}</h3>
    <h3><b>Contact Info:</b> ${serviceRequest.contactInfo}</h3>
    <h3><b>Issue:</b> ${serviceRequest.description}</h3>
    <h3><b>Ticket Number:</b> ${serviceRequest.requestId}</h3>
  </div>
...
<!-- Footer -->
<div class="w3-light-grey w3-container w3-padding-32" style="margin-top:315px;padding-right:58px"><p class="w3-right">Pathway Help Desk LLC</p></div>
