...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="requestAdmin" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Technician Login</a> 
    <a href="admin.jsp" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Admin Login</a> 
  </div>
</nav>
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="contact" style="margin-top:75px">
    ...
    <h3 class="w3-xlarge w3-text-red"><b>Invalid login, please try again</b></h3>
    <a href="index.jsp"><h3>Login</h3></a>
  </div>
